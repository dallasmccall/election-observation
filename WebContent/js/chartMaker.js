...
function pieChart() {
  ...
  var centerX;                      // X-coordinate of center of the canvas/chart
  var centerY;                      // Y-coordinate of center of the canvas/chart
  ...
  function handleChartClick ( clickEvent ) {
    ...
    if ( distanceFromcenter <= chartRadius ) {
      ...
      // Find the slice that was clicked by comparing angles relative to the chart center.
  ...
  function drawSlice ( context, slice ) {
    ...
    if ( slice == currentPullOutSlice ) {
      ...
      // Offset it from the pie center, draw the text label,
      ...
      // This slice isn't pulled out, so draw it from the pie center
      startX = centerX;
      startY = centerY;
    }
